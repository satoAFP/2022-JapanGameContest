...
public class checkpos : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if(other.gameObject.tag=="Conductor"||other.gameObject.tag == "ColorInput" || other.gameObject.tag == "ColorOutput"|| other.gameObject.tag == "Rotate"|| other.gameObject.tag == "ColorMix"
